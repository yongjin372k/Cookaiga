          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                canvaImage('cooking_child.png', width: 150, height: 150),
                const SizedBox(height: 10),
                canvaImage('cooking_adult.png', width: 150, height: 150),
                const SizedBox(height: 10),
                canvaImage('cooking_together.png', width: 150, height: 150),
              ],
            ),
          ),
